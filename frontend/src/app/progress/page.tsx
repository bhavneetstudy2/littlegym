          ...
          <div className="flex-1 overflow-y-auto overscroll-contain">
            ...
            <div className="p-4 bg-blue-50/60 border-b border-blue-100">
              <div className="grid grid-cols-1 gap-3">
                <div>
                  <label className="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">Parent Expectation</label>
                  <textarea
                    ...
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 resize-none"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-gray-600 mb-1 uppercase tracking-wide">
                    Progress Check
                    {savingNotes && <span className="ml-2 text-blue-500 font-normal normal-case">saving...</span>}
                  </label>
                  <textarea
                    value={progressCheck}
                    onChange={e => onNotesChange('check', e.target.value)}
                    rows={2}
                    placeholder="Trainer's notes for this week"
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 resize-none"
                  />
                </div>
              </div>
              ...
              Object.entries(groupedActivities).map(([groupName, cats]) => (
                <div key={groupName}>
                  ...
                  {cats.map(cat => {
                    ...
                    return (
                      <div key={cat.id} className="px-4 py-3 border-b border-gray-100 last:border-0">
                        {/* Skill name */}
                            ...
                            {cat.progression_levels.map(level => {
                              ...
                              return (
                                <button
                                  ...
                                  disabled={isSaving}
                                  className={`
                                    px-3.5 py-2 rounded-full text-sm transition-all active:scale-95
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              onBlur={e => {
                                ...
                                // For numeric we update the entry value directly then save
                              ...
                              placeholder="—"
                              className="w-24 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-center"
                            />
