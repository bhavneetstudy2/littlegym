...
def upgrade() -> None:
    ...
    # Create centers table without foreign keys first
    ...
    op.create_foreign_key('fk_centers_created_by', 'centers', 'users', ['created_by_id'], ['id'])
    op.create_foreign_key('fk_centers_updated_by', 'centers', 'users', ['updated_by_id'], ['id'])
    op.create_foreign_key('fk_users_center', 'users', 'centers', ['center_id'], ['id'])
